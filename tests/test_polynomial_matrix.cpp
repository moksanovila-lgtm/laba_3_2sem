...
protected:
    void SetUp() override {
        ...
        poly = new Polynomial<ArraySequence, Matrix<int>>{I, I * 2, I * 3};
    }
    ...
    ~PolynomialMatrixTest() noexcept = default;
    
    Matrix<int> I;
    Matrix<int> X;
    Polynomial<ArraySequence, Matrix<int>>* poly;
};
...
TEST_F(PolynomialMatrixTest, Constructor) {
    ...
    EXPECT_EQ(coeff0, I) << "Coefficient 0 should be identity";
    EXPECT_EQ(coeff1, I * 2) << "Coefficient 1 should be 2I";
    EXPECT_EQ(coeff2, I * 3) << "Coefficient 2 should be 3I";
}
...
TEST_F(PolynomialMatrixTest, Add) {
    Polynomial<ArraySequence, Matrix<int>> p2{I, I};
...
TEST_F(PolynomialMatrixTest, Multiply) {
    Polynomial<ArraySequence, Matrix<int>> p1{I, I};        
    Polynomial<ArraySequence, Matrix<int>> p2{I * 2, I * 2};
